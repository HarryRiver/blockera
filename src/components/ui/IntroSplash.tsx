	...
	return (
		<div className={`${styles.splash} ${phase >= 6 ? styles.exit : ""}`}>
			...
			<div className={styles.center}>
				...
				<div
					className={`${styles.logo} ${phase >= 2 ? styles.logoShow : ""} ${phase >= 3 ? styles.logoColor : ""}`}
				>
					<Image
				...
				<div className={styles.brandRow}>
					<span
						className={`${styles.brandB} ${phase >= 3 ? styles.brandBShow : ""}`}
					>
						B
					</span>
					<span
						className={`${styles.brandRest} ${phase >= 4 ? styles.brandRestShow : ""}`}
					>
						LOCKERA
					</span>
				</div>
				...
				{/* Expanding line */}
				<div
					className={`${styles.midLine} ${phase >= 5 ? styles.midLineShow : ""}`}
				/>

				{/* Tagline — bigger */}
				<div
					className={`${styles.tagline} ${phase >= 5 ? styles.taglineShow : ""}`}
				>
			...
			{/* Bottom shimmer */}
			<div
				className={`${styles.shimmer} ${phase >= 4 ? styles.shimmerShow : ""}`}
			/>
		</div>
	);
}
