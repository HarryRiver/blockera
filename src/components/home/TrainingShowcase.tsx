...
const showcasePrograms = [
    {
        ...
        videoHref: '/chuong-trinh/ca-nhan',
    },
    {
        id: 'doanh-nghiep',
        title: 'Doanh nghiệp',
        ...
        videoHref: '/chuong-trinh/doanh-nghiep',
    },
    {
        id: 'co-quan',
        ...
        videoHref: '/chuong-trinh/co-quan-nha-nuoc',
    },
];
        ...
        <section className={styles.trainingShowcase} ref={ref}>
            <div className="container">
                ...
                <p className="section-subtitle center">
                    Mỗi đối tượng đều có khung album hình ảnh và video minh họa thực tế
                </p>

                <div className={`${styles.showcaseGrid} ${isRevealed ? styles.revealed : ''}`}>
                        ...
                        <article key={program.id} className={styles.showcaseCard}>
                            ...
                            <div className={styles.albumFrame}>
                                {program.album.map((src, index) => (
                                    <div key={src} className={styles.albumThumb}>
                                        <Image
                                            src={src}
                            ...
                            <Link href={program.videoHref} className={styles.videoFrame} aria-label={`Xem video minh họa ${program.title}`}>
                                <Image
